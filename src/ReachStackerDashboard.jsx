...
const ReachStackerDashboard = () => {
    ...
    if ("Notification" in window) {
      ...
      if (permission === "granted") {
        ...
        showNotification(
          ...
          "Anda akan menerima alert emergency",
          "success"
        );
      }
    }
  ...
  const currentStatus = latestData
    ? getStatus(
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              <div
                className={`w-4 h-4 rounded-full ${currentRS?.color} ${
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-red-100">
                  Unit {selectedRS} dalam kondisi emergency stop
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          ...
          <SensorCard
            ...
            unit="bar"
            status={
              latestData?.pressure > 150
                ? "danger"
                : latestData?.pressure > 130
                ? "warning"
                : "normal"
            }
          />
          <SensorCard
            ...
            unit="%"
            status={
              latestData?.hydraulicOil < 30
                ? "danger"
                : latestData?.hydraulicOil < 50
                ? "warning"
                : "normal"
            }
          />
          <SensorCard
            ...
            unit="%"
            status={
              latestData?.fuelLevel < 20
                ? "danger"
                : latestData?.fuelLevel < 40
                ? "warning"
                : "normal"
            }
          />
